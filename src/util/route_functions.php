...
//generates access token form client credentials
function generate_access_token_with_client_credentials()
{
    $config = get_config();
    $oauth_config = array(
    ...
    $oauth_details = ['status' => 'OK', 'access_token' => $response['result']['data']['access_token']];
